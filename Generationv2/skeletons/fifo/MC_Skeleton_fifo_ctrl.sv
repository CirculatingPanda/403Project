//==============================================================================
// FIFO Controller Skeleton
// High-accuracy template with minimal TODOs
//
// Parameters from spec.json:
//   {{MODULE_NAME}}, {{DATA_WIDTH}}, {{FIFO_DEPTH}}, {{FIFO_ADDR_BITS}}
//   {{ALMOST_FULL}}, {{ALMOST_EMPTY}}
//==============================================================================

`timescale 1ns / 1ps

module {{MODULE_NAME}}_fifo_ctrl #(
    parameter int DATA_WIDTH   = {{DATA_WIDTH}},
    parameter int DEPTH        = {{FIFO_DEPTH}},
    parameter int ADDR_BITS    = {{FIFO_ADDR_BITS}},
    parameter int ALMOST_FULL  = {{ALMOST_FULL}},
    parameter int ALMOST_EMPTY = {{ALMOST_EMPTY}}
) (
    input  logic                  clk,
    input  logic                  rst_n,
...
endmodule : {{MODULE_NAME}}_fifo_ctrl
